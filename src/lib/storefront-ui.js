...
export const SIDEBAR_THEMES = {
  minimal: {
    ...
    invertLogo: false,
    bottomBar: "bg-white/95 border-t border-zinc-100",
    bottomIdle: "text-zinc-500",
    bottomActive: "text-zinc-900",
    bottomBadge: "bg-zinc-900 text-white",
    bottomPress: "active:bg-zinc-100",
  },
  dark: {
    label: "Midnight",
    ...
    invertLogo: true,
    bottomBar: "bg-zinc-950/95 border-t border-zinc-800",
    bottomIdle: "text-zinc-400",
    bottomActive: "text-white",
    bottomBadge: "bg-white text-zinc-900",
    bottomPress: "active:bg-zinc-900",
  },
  slate: {
    label: "Slate",
    ...
    accentBadge: "bg-white/20 text-white",
    invertLogo: false,
    bottomBar: "bg-slate-50/95 border-t border-slate-200",
    bottomIdle: "text-slate-500",
    bottomActive: "text-slate-900",
    bottomBadge: "bg-slate-800 text-white",
    bottomPress: "active:bg-slate-200",
  },
  elegant: {
    label: "Elegant",
    ...
    accentBadge: "bg-white/20 text-white",
    invertLogo: false,
    bottomBar: "bg-[#faf7f0]/95 border-t border-[#e8dfc9]",
    bottomIdle: "text-[#a89468]",
    bottomActive: "text-[#8b6f2f]",
    bottomBadge: "bg-[#8b6f2f] text-white",
    bottomPress: "active:bg-[#f3ecd8]",
  },
  vibrant: {
    label: "Ocean",
    ...
    accentBadge: "bg-white/20 text-white",
    invertLogo: false,
    bottomBar: "bg-white/95 border-t border-blue-100",
    bottomIdle: "text-zinc-500",
    bottomActive: "text-blue-600",
    bottomBadge: "bg-blue-600 text-white",
    bottomPress: "active:bg-blue-50",
  },
  emerald: {
    label: "Emerald",
    ...
    accentBadge: "bg-white/20 text-white",
    invertLogo: false,
    bottomBar: "bg-white/95 border-t border-emerald-100",
    bottomIdle: "text-zinc-500",
    bottomActive: "text-emerald-600",
    bottomBadge: "bg-emerald-600 text-white",
    bottomPress: "active:bg-emerald-50",
  },
  rose: {
    label: "Rose",
    ...
    accentBadge: "bg-white/20 text-white",
    invertLogo: false,
    bottomBar: "bg-white/95 border-t border-rose-100",
    bottomIdle: "text-zinc-500",
    bottomActive: "text-rose-600",
    bottomBadge: "bg-rose-600 text-white",
    bottomPress: "active:bg-rose-50",
  },
  sunset: {
    label: "Sunset",
    ...
    accentBadge: "bg-white/20 text-white",
    invertLogo: false,
    bottomBar: "bg-white/95 border-t border-orange-100",
    bottomIdle: "text-zinc-500",
    bottomActive: "text-orange-600",
    bottomBadge: "bg-orange-600 text-white",
    bottomPress: "active:bg-orange-50",
  },
  royal: {
    label: "Royal",
    ...
    accentBadge: "bg-white/20 text-white",
    invertLogo: true,
    bottomBar: "bg-indigo-950/95 border-t border-indigo-900",
    bottomIdle: "text-indigo-300",
    bottomActive: "text-white",
    bottomBadge: "bg-violet-500 text-white",
    bottomPress: "active:bg-indigo-900",
  },
};
